...
public interface UFABCGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link UFABCGrammarParser#unusedFlag}.
	 * @param ctx the parse tree
	 */
	void enterUnusedFlag(UFABCGrammarParser.UnusedFlagContext ctx);
	/**
	 * Exit a parse tree produced by {@link UFABCGrammarParser#unusedFlag}.
	 * @param ctx the parse tree
	 */
	void exitUnusedFlag(UFABCGrammarParser.UnusedFlagContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link UFABCGrammarParser#opNot}.
	 * @param ctx the parse tree
	 */
	void enterOpNot(UFABCGrammarParser.OpNotContext ctx);
	/**
	 * Exit a parse tree produced by {@link UFABCGrammarParser#opNot}.
	 * @param ctx the parse tree
	 */
	void exitOpNot(UFABCGrammarParser.OpNotContext ctx);
	/**
